...
diretorio = r'C:\Users\ABRASEL NACIONAL\Documents\CNPJ_PROGRAMATICA\EMPRESASZIP/'
all_files = list(filter(lambda x: '.csv' in x, os.listdir(diretorio)))
diretorio_destino = r'C:\Users\ABRASEL NACIONAL\Documents\CNPJ_PROGRAMATICA\EMPRESASCSV'
